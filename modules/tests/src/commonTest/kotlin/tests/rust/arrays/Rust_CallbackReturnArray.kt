...
class Rust_CallbackReturnArray {
    ...
    @Test
    fun callbackReturnInterfaceArray() = withRustLib {
        val elements = arrayOf(
            MyInterface(),
            MyInterface()
        )
        assertTrue(natives.testrs.callbackReturnInterfaceArray {
            elements
        })
    ...
    @Test
    fun callbackReturnInterfaceArrayN() = withRustLib {
        assertTrue(natives.testrs.callbackReturnInterfaceArrayN {
            arrayOf(null, null)
        })
    }
}