...
class Rust_CallbackArgPrimitive {
    ...
    @Test
    fun callbackArgInterface() = withRustLib {
        val obj = MyInterface()
        assertTrue(natives.testrs.callbackArgInterface(obj) { it == obj })
    }

    @Test
    fun callbackArgInterfaceN() = withRustLib {
        assertTrue(natives.testrs.callbackArgInterfaceN { it == null })
    }
}