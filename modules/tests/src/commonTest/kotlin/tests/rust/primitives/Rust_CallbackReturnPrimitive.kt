...
class Rust_CallbackReturnPrimitive {
    ...
    @Test
    fun callbackReturnInterface() = withRustLib {
        assertTrue(natives.testrs.callbackReturnInterface { MyInterface() })
    }

    @Test
    fun callbackReturnInterfaceN() = withRustLib {
        assertTrue(natives.testrs.callbackReturnInterfaceN { null })
    }
}