...
class C_CallbackArgPrimitive {
    ...
    @Test
    fun callbackArgInterface() = withCLib {
        val obj = MyInterface()
        assertTrue(natives.test.callbackArgInterface(obj) { arg ->
            arg.use { arg == obj }
        })
        obj.close()
    }
    ...
    @Test
    fun callbackArgInterfaceN() = withCLib {
        assertTrue(natives.test.callbackArgInterfaceN { it == null })
    }
}