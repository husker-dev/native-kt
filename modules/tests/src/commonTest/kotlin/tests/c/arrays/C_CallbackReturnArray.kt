...
class C_CallbackReturnArray {
    ...
    @Test
    fun callbackReturnInterfaceArray() = withCLib {
        val array = arrayOf(
            MyInterface(),
            MyInterface()
        )
        assertTrue(natives.test.callbackReturnInterfaceArray {
            array
        })
    ...
    @Test
    fun callbackReturnInterfaceArrayN() = withCLib {
        assertTrue(natives.test.callbackReturnInterfaceArrayN {
            arrayOf(null, null)
        })
    }
}