...
class Cpp_CallbackReturnArray {
    ...
    @Test
    fun callbackReturnInterfaceArray() = withCppLib {
        val array = arrayOf(
            MyInterface(),
            MyInterface()
        )
        assertTrue(natives.testcpp.callbackReturnInterfaceArray {
            array
        })
    ...
    @Test
    fun callbackReturnInterfaceArrayN() = withCppLib {
        assertTrue(natives.testcpp.callbackReturnInterfaceArrayN {
            arrayOf(null, null)
        })
    }
}