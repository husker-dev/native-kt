...
class Cpp_CallbackArgPrimitive {
    ...
    @Test
    fun callbackArgInterface() = withCppLib {
        val obj = MyInterface()
        assertTrue(natives.testcpp.callbackArgInterface(obj) { arg ->
            arg.use { arg == obj }
        })
        obj.close()
    }
    ...
    @Test
    fun callbackArgInterfaceN() = withCppLib {
        assertTrue(natives.testcpp.callbackArgInterfaceN { it == null })
    }
}