...
export_fn! {	
	fn nativekt_natives_jvmcibindings_jvmci_bindings__string_new(data: *mut u8, _length: i32, size: i32, make_copy: bool) -> *mut String as C_ {
	    if make_copy {
...
export_fn!{ fn nativekt_natives_jvmcibindings_jvmci_bindings_call_critical_jvmci_string(arg: *mut u8, _arg_length: i32, _arg_size: i32) -> () as N_ {
