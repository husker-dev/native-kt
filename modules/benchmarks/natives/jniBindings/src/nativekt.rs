...
#[no_mangle] 
unsafe extern "C" fn nativekt_natives_jnibindings_jni_bindings__init() {}
...
export_fn! {
    fn nativekt_natives_jnibindings_jni_bindings__alloc(size: usize) -> *mut u8 as A_ {
        unsafe { alloc(Layout::from_size_align_unchecked(size, 1)) }
    }
    fn nativekt_natives_jnibindings_jni_bindings__dealloc(ptr: *mut u8, size: usize) -> () as B_ {
...
export_fn!{ fn nativekt_natives_jnibindings_jni_bindings_call_jni() -> () as L_ {
    crate::call_jni()
}}
export_fn!{ fn nativekt_natives_jnibindings_jni_bindings_call_jni_add(a: i32, b: i32) -> i32 as M_ {
